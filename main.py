...
def GamOver(b):
  ...
  if b [2] [0]> 0 and b [2] [0] == b [2] [1] and b [0] [1] == b [2] [2]:return b [2] [2]
...
def play  (x,y):
  ...
  if result == 1:
    if screen.textinput ("Game over!", "X won! Do you want to play again?"):
      screen.clear () 
      b = [[0, 0, 0], [0, 0, 0  ], [0, 0, 0]] 
      drawBoard () 
      start (b) 
    ...
    if screen.textinput ("Game over!", "0 won! Do you want to play again?  "): 
      screen.clear () 
      b= [[0, 0, 0], [0, 0, 0], [0, 0, 0] ]
      drawBoard ()
      start(b)
